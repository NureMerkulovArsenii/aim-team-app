...
namespace PL.Console.ResetPassword
{
    public class ResetPasswordControl : IResetPasswordControl
    {
        ...
        public ResetPasswordControl(IUserService userService, IAuthorizationService authorizationService, IMailWorker mailWorker, IPasswordService passwordService)
        {
        ...
        public async Task<bool> ResetUserPasswordAsync()
        {
            ...
            } while (string.IsNullOrWhiteSpace(password) || !_passwordService.HasPasswordCorrectFormat(email, password));
